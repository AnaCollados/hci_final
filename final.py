...
if selected == "Projects":
    ...
    def blue():
        ...
        if col2.button('Buy this item', key="<motomami>"):
            col2.write('This is not a real link, but thanks for clicking')
...
if selected == "About":
    ...
    *and I usually work with my hair up and comfortable clothes.
    ...
    with st.expander('Purpose investigation'):
        ...
        you could contact the researchers trhough these emails if you want to know more:
        Ana: 202103220@post.au.dk
        Alaina: alainamartine@gmail.com
        ''')
